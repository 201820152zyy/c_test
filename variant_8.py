...
BEST_MODEL_PATH = 'model/patch_variant_8_finetune_1_epoch_best_model.sav'
CURRENT_MODEL_PATH = 'model/patch_variant_8_finetune_1_epoch_best_model.sav'
NUMBER_OF_EPOCHS = 60
...
def train(model, learning_rate, number_of_epochs, training_generator, val_generator, test_Cp_generator, test_C_generator):
...
def do_train():
    ...
    test_Cp_set = VariantEightDataset(test_Cp_ids, id_to_label, id_to_url, EMBEDDING_DIRECTORY)
    test_C_set = VariantEightDataset(test_C_ids, id_to_label, id_to_url, EMBEDDING_DIRECTORY)
    ...
    test_Cp_generator = DataLoader(test_Cp_set, **TEST_PARAMS, collate_fn=custom_collate)
    test_C_generator = DataLoader(test_C_set, **TEST_PARAMS, collate_fn=custom_collate)
