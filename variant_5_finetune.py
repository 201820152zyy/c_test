...
def do_train():
    ...
    test_Cp_set = VariantFiveFinetuneDataset(test_Cp_ids, id_to_label, id_to_url, id_to_added_input, id_to_added_mask, id_to_removed_input, id_to_removed_mask)
    test_C_set = VariantFiveFinetuneDataset(test_C_ids, id_to_label, id_to_url, id_to_added_input, id_to_added_mask, id_to_removed_input, id_to_removed_mask)
