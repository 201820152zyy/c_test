...
def do_train():
    ...
    test_Cp_set = VariantTwoFineTuneDataset(test_Cp_ids, id_to_label, id_to_url, id_to_input_list, id_to_mask_list)
    test_C_set = VariantTwoFineTuneDataset(test_C_ids, id_to_label, id_to_url, id_to_input_list, id_to_mask_list)
