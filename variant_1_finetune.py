...
def do_train():
    ...
    test_Cp_set = VariantOneFinetuneDataset(test_Cp_ids, id_to_label, id_to_url, id_to_input, id_to_mask)
    test_C_set = VariantOneFinetuneDataset(test_C_ids, id_to_label, id_to_url, id_to_input, id_to_mask)
