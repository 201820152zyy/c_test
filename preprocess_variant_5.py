...
EMBEDDING_DIRECTORY = '../embeddings/variant_5'
...
def get_data():
    tokenizer = RobertaTokenizer.from_pretrained("/Users/zyyyyy/Documents/data/c_test/codebert-basee")
    code_bert = RobertaModel.from_pretrained("/Users/zyyyyy/Documents/data/c_test/codebert-base", num_labels=2)
