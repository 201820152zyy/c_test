...
def do_train():
    ...
    test_Cp_set = VariantSevenDataset(test_Cp_ids, id_to_label, id_to_url, EMBEDDING_DIRECTORY)
    test_C_set = VariantSevenDataset(test_C_ids, id_to_label, id_to_url, EMBEDDING_DIRECTORY)
