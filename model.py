...
class VariantTwoFineTuneClassifier(nn.Module):
    def __init__(self):
        ...
        self.HIDDEN_DIM = 768
        self.code_bert = RobertaModel.from_pretrained("codebert-base", num_labels=2)
...
class VariantThreeFineTuneClassifier(nn.Module):
    def __init__(self):
        ...
        self.HIDDEN_DIM = 768
        self.code_bert = RobertaModel.from_pretrained("/Users/zyyyyy/Documents/data/c_test/codebert-base", num_labels=2)
