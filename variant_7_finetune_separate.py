...
from entities import VariantSevenFineTuneOnlyDataset
...
BEST_MODEL_PATH = 'model/patch_variant_7_finetune_best_model.sav'
...
def get_data():
    ...
    for item in items:
        ...
        url_to_hunk[url].extend(preprocess_variant_3.get_hunk_çfrom_diff(diff))
    ...
    for key in url_to_hunk.keys():
        url = key
        diff = url_to_hunk[key]
