...
def do_train():
    ...
    test_Cp_set = VariantOneDataset(test_Cp_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
    test_C_set = VariantOneDataset(test_C_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
